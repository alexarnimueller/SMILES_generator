...
flags = tf.app.flags
flags.DEFINE_string("dataset", "data/chembl24_10uM_10-200.csv", "dataset file (expecting csv or pickled file)")
...
flags.DEFINE_integer("n_mols", 0, "number of molecules to sample for training every epoch (if 0, use all)")
