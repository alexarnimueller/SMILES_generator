...
flags = tf.app.flags
flags.DEFINE_string("dataset", "data/chemregmed.csv", "dataset file containing smiles strings")
flags.DEFINE_string("run_name", "chemregmed", "run name for log and checkpoint files")
...
flags.DEFINE_integer("neurons", 128, "number of neurons per layer")
...
flags.DEFINE_integer("n_mols", 0, "number of molecules to pick for training every epoch (if 0, use all)")
