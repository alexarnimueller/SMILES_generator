...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", required=True, type=str, default="checkpoint/combined_data_a5_adLR/",
                        help="path (folder) of the pretrained model")
    parser.add_argument("--dataset", required=True, type=str, default="data/actives.csv",
                        help="dataset for fine tuning")
    parser.add_argument("--name", type=str, default="combined_a5LR_hits_ft_actives", help="run_name for output files")
    parser.add_argument("--lr", type=float, default=0.005, help="learning rate")
    parser.add_argument("--epoch", type=int, default=5, help="epoch_to_load")
    parser.add_argument("--train", type=int, default=5, help="number of epochs to fine tune")
    parser.add_argument("--sample", type=int, default=100, help="number of points to sample during and after training")
    ...
    parser.add_argument("--batch", type=int, default=16, help="batchsize used for finetuning")
    ...
    parser.add_argument('--no-reinforce', dest='reinforce', action='store_false',
                        help="add most similar but novel generated mols back to training")
    parser.set_defaults(reinforce=True)
